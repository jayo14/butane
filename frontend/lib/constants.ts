...
export const NAV_ITEMS: NavItem[] = [
  ...
  { label: "Generate Reports", href: "/dashboard/report-cards/generate", icon: "sparkles" },
  { label: "Reports Archive", href: "/dashboard/report-cards/archive", icon: "archive" },
  { label: "Report Approval", href: "/dashboard/report-cards/approval", icon: "check-circle" },
  { label: "Report Customization", href: "/dashboard/report-cards/customize", icon: "palette" },
  { label: "Teacher Remarks", href: "/dashboard/report-cards/remarks", icon: "message-square" },
  { label: "Mark Sheet", href: "/dashboard/report-cards/mark-sheet", icon: "clipboard-list" },
  { label: "Review Dashboard", href: "/dashboard/report-cards/review", icon: "bar-chart-3" },
