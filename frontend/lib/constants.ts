...
export const NAV_ITEMS: NavItem[] = [
  ...
  { label: "Generate Reports", href: "/dashboard/report-cards/generate", icon: "file-text" },
  { label: "Reports Archive", href: "/dashboard/report-cards/archive", icon: "file-text" },
  { label: "Report Approval", href: "/dashboard/report-cards/approval", icon: "file-text" },
  { label: "Report Customization", href: "/dashboard/report-cards/customize", icon: "settings" },
  { label: "Teacher Remarks", href: "/dashboard/report-cards/remarks", icon: "pen-tool" },
